...
GGML_CUDA_GRAPH_OPT="$GRAPH_OPT_VAL" sudo -E ncu --metrics dram__bytes.sum,dram__throughput.avg.pct_of_peak_sustained_elapsed,sm__throughput.avg.pct_of_peak_sustained_elapsed,gpu__time_duration.sum \
